...
public class UserService {
    ...
    public UserRespone getMyInfo() {
        ...
        return userMapper.toUserRespone(
                userRepository.findByEmail(email).orElseThrow(() -> new AppException(ErrorCode.USER_NOTFOUND)));
    }
    ...
    public ApiResponse fotgotPassword(ForgotPasswordRequest request) {
        ...
        userRepository.save(user);
        ApiResponse apiResponse = new ApiResponse().builder().result(user).build();
        return apiResponse;
    }
